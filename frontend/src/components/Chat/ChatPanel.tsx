...
export const ChatPanel: React.FC = () => {
    ...
    return (
        <div className="flex h-full min-h-0 bg-zinc-950 border-r border-zinc-800 overflow-hidden relative">
            {/* Thread List Sidebar */}
            <ThreadList
            ...
            <div className="flex-1 flex flex-col min-h-0 min-w-0 bg-zinc-950 overflow-hidden">
                {/* Header */}
                <div className="shrink-0 p-3 border-b border-zinc-800 flex justify-between items-center bg-zinc-950">
                ...
                {/* Messages */}
                <div className="flex-1 min-h-0 overflow-y-auto px-3 pt-3 pb-2 custom-scrollbar">
                    <MessageList />
                </div>
